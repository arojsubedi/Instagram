...
import loginlogo from './static/images/loginpage.jpeg';
import instagramlogo from './static/images/instragramloginheaderpic.png'
...
export default function LoginForm({settingUserName}) {
    ...
    const goToSignInWindow=(e)=>{
        checkSignInWindow(!signInWindow)
    }
    return (
        signInSignUpWindow?
            (!signInWindow)?(
                    ...
                    <div className="row">
                        ...
                        <div className="col-10 col-md-5 signInSignUp" >
                            ...
                            <div className="signUp">
                                Don't have an account? <a href="#" onClick={(e)=>{goToSignInWindow()}}className="signUp__link">Sign Up</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-10 col-md-5 signInSignUp" >
                            <div className="login__form">
                                <div className="user__input">
                                    ...
                                    <Button className="login__button" block={true} variant="primary" type="submit" onClick={(e)=>{onUserSignup(e)}}>Sign Up</Button>
                                </div>
                                
                            </div>
                            <div className="signUp">
                                Already have an account? <a href="#" onClick={(e)=>{goToSignInWindow()}}className="signUp__link">Log In</a>
                            </div>
                        </div>
                    </div>
                </div>
